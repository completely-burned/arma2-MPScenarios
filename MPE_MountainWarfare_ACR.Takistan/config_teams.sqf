...
_n = _n	+ ["Recon"];
_d = _d	+ [GetText (configFile >> "CfgVehicles" >> "BAF_Jackal2_L2A1_D" >> "displayName")];
_t = _t + [_MECHANIZED];
_ab=_ab + [_TEAMTYPENORMAL];
_ai=_ai	+ [false];
_f = _f	+ [_faction];
...
_d = _d	+ [GetText (configFile >> "CfgVehicles" >> "BAF_Offroad_D" >> "displayName")];
_t = _t + [_MECHANIZED];
...
_d = _d	+ [GetText (configFile >> "CfgVehicles" >> "BAF_FV510_D" >> "displayName")];
_t = _t + [_MECHANIZED];
_ab=_ab + [_TEAMTYPENORMAL];
_ai=_ai	+ [false];
_f = _f	+ [_faction];
